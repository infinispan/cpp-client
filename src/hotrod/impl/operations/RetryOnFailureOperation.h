...
// Specialization for void operation. The one above doesn't work because involves reference to void
template<> class RetryOnFailureOperation<void> : public HotRodOperation<void>
{
  public:
    void execute() {
        int retryCount = 0;
  ...
  protected:
    ...
    virtual void executeOperation(transport::Transport& transport) = 0;
