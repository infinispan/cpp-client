        ...
        namespace operations
        {
            ...
            ExecuteCmdOperation::ExecuteCmdOperation(
                ...
                : RetryOnFailureOperation<std::vector<char>>(
                  ...
                  cmdName(cmdName_), cmdArgs(cmdArgs_)
            {
            }
            ...
            ExecuteCmdKeyOperation::ExecuteCmdKeyOperation(
                const Codec &codec_,
                std::shared_ptr<transport::TransportFactory> transportFactory_,
            ...
            std::vector<char> ExecuteCmdKeyOperation::executeOperation(Transport &transport)
            {
                return sendExecuteOperation(transport, EXEC_REQUEST, EXEC_RESPONSE);
            }

            std::vector<char> ExecuteCmdKeyOperation::sendExecuteOperation(
                transport::Transport &transport,
                uint8_t opCode,
                uint8_t /*opRespCode*/)
            {
