...
ClusterStatus RemoteCacheManager::switchOnFailoverCluster()
{
  return IMPL->switchOnFailoverCluster();
}
ClusterStatus RemoteCacheManager::switchOnMainCluster()
{
	return IMPL->switchOnMainCluster();
}
