...
public class SslConfigurationBuilder extends AbstractConfigurationChildBuilder implements Builder<SslConfiguration> {
   ...
   private org.infinispan.client.hotrod.jni.SslConfigurationBuilder jniSslConfigurationBuilder;

   public SslConfigurationBuilder(ConfigurationBuilder builder,
         org.infinispan.client.hotrod.jni.SslConfigurationBuilder jniSslConfigurationBuilder) {
      super(builder);
