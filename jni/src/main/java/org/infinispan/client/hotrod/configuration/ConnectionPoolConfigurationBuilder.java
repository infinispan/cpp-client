...
public class ConnectionPoolConfigurationBuilder extends AbstractConfigurationChildBuilder implements Builder<ConnectionPoolConfiguration> {
   ...
   private org.infinispan.client.hotrod.jni.ConnectionPoolConfigurationBuilder jniConnectionPoolConfigurationBuilder;

   public ConnectionPoolConfigurationBuilder(ConfigurationBuilder builder,
         org.infinispan.client.hotrod.jni.ConnectionPoolConfigurationBuilder jniConnectionPoolConfigurationBuilder) {
      super(builder);
