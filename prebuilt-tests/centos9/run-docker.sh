...
podman run -v `dirname "$SERVER_ZIP"`:/home/jboss/zip -v $RPM_PATH:/home/jboss/inst -v $TEST_SRC_PATH:/home/jboss/cpp-client -v $SCRIPT_PATH/image:/home/jboss/scripts -e SERVER_ZIP=`basename "$SERVER_ZIP"` -it cpp-test-machine-c9:latest /home/jboss/scripts/run-tests.sh


#podman run -v `dirname "$SERVER_ZIP"`:/home/jboss/zip -v /home/rigazilla/git/cpp-client/prebuilt-tests/:/home/jboss/inst -v /home/rigazilla/git/cpp-client:/home/jboss/cpp-client -v $SCRIPT_PATH/image:/home/jboss/scripts -e SERVER_ZIP=infinispan-server-11.0.4.Final.zip -it cpp-test-machine-c9:latest /home/jboss/scripts/run-tests.sh
fi
