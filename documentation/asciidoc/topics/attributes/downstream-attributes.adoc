...
:cli_docs: https://access.redhat.com/documentation/en-us/red_hat_data_grid/8.4/html-single/using_the_data_grid_command_line_interface/index
:cpp_api_docs: https://access.redhat.com/webassets/avalon/d/red-hat-data-grid/8.4/cpp/index.html
